...
Events = {
    updateWholePage: new Event(),
    rangeChangeEventer: new Event(),
    changeUpdateInterval: new Event(),
    changeVisibleDay: new Event(),
    immediateUpdate: new Event(),
    addCity: new Event(),
    changeToCelsius: new Event(),
    changeToFarenheit: new Event()
};
